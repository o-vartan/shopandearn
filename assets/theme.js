  ...
  var Cart = /*#__PURE__*/function () {
    ...
    _createClass(Cart, [{
      ...
      value: function _rerender() {
        ...
        document.dispatchEvent(new Event('rerenderTheme'));
    ...
    _createClass(ProductVariants, [{
      ...
      value: function _addToCart(event, target) {
        ...
        fetch("".concat(window.routes.cartAddUrl, ".js"), {
          ...
          //******** Custom script for checkout-timer-script ---- start ********//
          		document.dispatchEvent(new Event('checkoutTimerLaunch'));
          //******** Custom script for checkout-timer-script ---- end ********//
  ...
  */
  ...
  var ProductGallery = /*#__PURE__*/function () {
    function ProductGallery(element, options) {
      ...
      //******** Custom script for ask-price-script ---- start ********//
      		document.dispatchEvent(new Event('quickShopIsLoaded'));
      		console.log('quickShopIsLoaded');
	  //******** Custom script for ask-price-script ---- end ********//
    ...
    _createClass(ProductGallery, [{
      ...
      value: function _createCarousel() {
        ...
        if (this.productGalleryElement) {
          ...
          if (parseInt(this.productGalleryElement.getAttribute('data-media-count')) > 0) {
  ...
  var CollectionSection = /*#__PURE__*/function () {
    ...
    _createClass(CollectionSection, [{
      ...
      value: function _tagToggled(event, target) {
        ...
        //***************************************** Custom script add filter-busy class ---- start *****************************************//
        const activeFilters = document.querySelector('.collection__active-filters');
		const filters = document.querySelector('.collection__filter-group-list');
        
        activeFilters.classList.add('filters-busy');
		filters.classList.add('filters-busy');
        //***************************************** Custom script add filter-busy class ---- end *****************************************//
      ...
      value: function _reload(pushState) {
        ...
        return fetch(sectionUrl, {
          ...
          response.text().then(function (content) {
			...
			//***************************************** Custom script remove filter-busy class ---- start *****************************************//
        	const activeFilters = document.querySelector('.collection__active-filters.filters-busy');
			const filters = document.querySelector('.collection__filter-group-list.filters-busy');
        
        	if (activeFilters && filters) {
            	activeFilters.classList.remove('filters-busy');
				filters.classList.remove('filters-busy');
        	}
			//***************************************** Custom script remove filter-busy class ---- end *****************************************//
      ...
      value: function _loadRecommendations() {
        ...
        return fetch(url).then(function (response) {
          return response.text().then(function (content) {
            ...
            //******** Custom script for ask-price-script ---- start ********//
					document.dispatchEvent(new Event('youMayAlsoLikeBlockIsLoaded'));
					console.log('You may also like is rendered')
			//******** Custom script for ask-price-script ---- end ********//
      ...
      value: function _fetchProducts() {
        ...
        fetch("".concat(window.routes.searchUrl, "?view=").concat(template, "&type=product&q=").concat(queryString), {
          ...
          response.text().then(function (content) {
            ...
            //******** Custom script for ask-price-script ---- start ********//
				document.dispatchEvent(new Event('recentlyViewedBlockIsLoaded'));
